...
const Footer = () => {
    return (
        <div className="bg-[#0C1A32]">
            <footer className="footer p-10 bg-[#0C1A32] text-gray-400 container mx-auto">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#0C1A32] text-gray-400 border-base-300 container mx-auto">
